...
class PredictionRequest(BaseModel):
    surface: float = Field(..., gt=0, le=2000, description="Surface réelle bâtie (m²)")
    ...
    adresse_code_voie: str | None = Field(
        default=None,
        description="Code voie DVF (ex: '2345') — améliore la précision si disponible",
    )
